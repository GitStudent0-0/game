...
public:
  ...
  Menu(Font& font) :
    ...
    rulesText(font,
      ...
      L"1. Игроки по очереди соединяют две точки линией из 3 отрезков, параллельной\n\n"
      L"сторонам поля.\n\n"
      L"2. Если образуется треугольник, в него ставится фишка.\n\n"
      L"3. Игра заканчивается при выполнении условий завершения.\n\n"
      L"*Правила игры для модифицированной версии:\n\n"
      L"1. Игроки по очереди соединяют две точки линией от 1 до 3 отрезков, параллельной\n\n"
      L"сторонам поля.\n\n"
      L"2. Если образуется треугольник, в него ставится фишка.\n\n"
      L"3. Если точка используется 4 раза, она тускнеет.\n\n"
      L"4. Игра заканчивается при выполнении условий завершения.",
      30),
